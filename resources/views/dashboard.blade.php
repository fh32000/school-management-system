                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-20">
                                <div class="media">
                                    <div class="position-relative">
                                        <img class="img-fluid mr-15 avatar-small" src="{{asset("assets/images/blog/01.jpg")}}" alt="">
                                    </div>
                            ...
                            <li class="mb-20">
                                <div class="media">
                                    <div class="position-relative clearfix">
                                        <img class="img-fluid mr-15 avatar-small" src="{{asset("assets/images/blog/02.jpg")}}" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li class="mb-20">
                                <div class="media">
                                    <div class="position-relative">
                                        <img class="img-fluid mr-15 avatar-small" src="{{asset("assets/images/blog/03.jpg")}}" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="media">
                                    <div class="position-relative clearfix">
                                        <img class="img-fluid mr-15 avatar-small" src="{{asset("assets/images/blog/04.jpg")}}" alt="">
                                    </div>
                                    <div class="media-body">
                ...
                <div class="card card-statistics h-100">
                    ...
                    <div class="card-body text-center position-relative">
                        <div class="avatar-top">
                            <img class="img-fluid w-25 rounded-circle " src="{{asset("assets/images/blog/13.jpg")}}" alt="">
                        </div>
                        <div class="row">
