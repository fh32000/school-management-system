...
<!--=================================
 Main content -->
    ...
    <!--main cards widgets -->
    @include('dashboards.main_cards')
    <!-- income growth rates widgets-->
        @include('dashboards.income_growth_rates')
                        ...
                        <ul class="list-unstyled">
                                ...
                                <div class="media">
                                    <div class="position-relative">
                                        <img class="img-fluid mr-15 avatar-small"
                                             src="{{asset("assets/images/blog/01.jpg")}}" alt="">
                                    </div>
                            ...
                            <li class="mb-20">
                                <div class="media">
                                    <div class="position-relative clearfix">
                                        <img class="img-fluid mr-15 avatar-small"
                                             src="{{asset("assets/images/blog/02.jpg")}}" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li class="mb-20">
                                <div class="media">
                                    <div class="position-relative">
                                        <img class="img-fluid mr-15 avatar-small"
                                             src="{{asset("assets/images/blog/03.jpg")}}" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="media">
                                    <div class="position-relative clearfix">
                                        <img class="img-fluid mr-15 avatar-small"
                                             src="{{asset("assets/images/blog/04.jpg")}}" alt="">
                                    </div>
                                    <div class="media-body">
